...
var _user$project$Models$Chapter = F2(
	function (a, b) {
...
var _user$project$Chapters$onLinkClick = function (message) {
...
var _user$project$Chapters$viewChapterListItem = function (chapter) {
	return A2(
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$href('/chapters/1'),
							_1: {
								ctor: '::',
								_0: _user$project$Chapters$onLinkClick(
									_user$project$Msgs$ChangeLocation('/chapters/1')),
								_1: {ctor: '[]'}
							}
						},
						{
...
var _user$project$Chapters$viewChapterList = function (chapters) {
	var _p0 = chapters;
	if (_p0.ctor === 'Nothing') {
		return {
			ctor: '::',
		...
		return A2(_elm_lang$core$List$map, _user$project$Chapters$viewChapterListItem, _p0._0);
	}
};
var _user$project$Chapters$chapterListEndpoint = 'chapters';
var _user$project$Chapters$getChapters = function (model) {
	var url = A2(_elm_lang$core$Basics_ops['++'], model.backendConfig.backendURL, _user$project$Chapters$chapterListEndpoint);
	return A2(
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(_p0._0.title),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
...
var _user$project$Main$view = function (model) {
	var content = function () {
		...
		switch (_p0.ctor) {
			case 'ChaptersRoute':
				return _user$project$Chapters$viewChapterList(model.chapters);
			case 'ChapterRoute':
				...
				if (_p2._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								chapters: _elm_lang$core$Maybe$Just(_p2._0._0)
							}),
			...
			default:
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{pageData: _p3}),
					_1: _user$project$Main$updatePageData(_p3)
				};
		}
	});
